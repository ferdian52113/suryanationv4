                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <?php 
                                                            $js = array( 'class' => 'form-control', 'id' =>  $kr[$i]->idProProd."-picreset");
        ...
        function passing<?php echo $kr[$i]->idProProd ?>() {
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[id='<?php echo $kr[$i]->idProProd?>-krum?>-password-1']").val(Vals[0].idUser);
                    }
            });
        }
</script>
<script type="text/javascript">
        function cekkrum<?php echo $kr[$i]->idProProd?>() {
            var idUser = document.getElementById('<?php echo $kr[$i]->idProProd ?>-krum?>-password-1').value;
