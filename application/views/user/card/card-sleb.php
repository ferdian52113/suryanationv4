                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <?php 
                                                            $js = array( 'class' => 'form-control', 'id' =>  $sl[$i]->idProProd."-picreset");
        ...
        function passing<?php echo $sl[$i]->idProProd ?>() {
            ...
            $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[id='<?php echo $sl[$i]->idProProd?>-sleb?>-password-1']").val(Vals[0].idUser);
                    }
            });
        }
</script>
<script type="text/javascript">
        function ceksleb<?php echo $sl[$i]->idProProd?>() {
            var idUser = document.getElementById('<?php echo $sl[$i]->idProProd ?>-sleb?>-password-1').value;
